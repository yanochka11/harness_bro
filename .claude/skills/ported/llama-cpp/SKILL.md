---
name: llama-cpp
description: 'Use when running local GGUF inference via llama.cpp or discovering GGUF models on HF Hub. Triggers: llama.cpp, GGUF, local inference, quantized model.'
version: 2.1.2
tags:
- llama.cpp
- GGUF
