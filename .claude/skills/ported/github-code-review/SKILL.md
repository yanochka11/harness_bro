...
description: 'Use when reviewing GitHub pull requests — examining diffs, leaving inline comments via gh or REST API. Triggers: review PR, code review, look at PR.'
version: 1.1.0
tags:
- GitHub
- Code-Review
