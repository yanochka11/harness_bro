...
description: 'Use when working with HuggingFace models cached locally. Triggers: local hf model, cached model, hf cache. Metal, CUDA, or ROCm. Covers finding GGUFs, quant selection, running servers, exact GGUF file lookup, conversion, and OpenAI-compatible local serving.'
---
