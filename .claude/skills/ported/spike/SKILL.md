---
name: spike
description: "Use when неясно сработает ли подход — проверить дёшево перед полной реализацией. Triggers: спайк, прототип, проверь идею, throwaway experiment, validate approach, можно ли так сделать. Pattern: 1-2 часа exploration → выводы → решение build/discard."
version: 1.0.0
