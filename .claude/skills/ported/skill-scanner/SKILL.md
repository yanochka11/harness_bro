---
name: skill-scanner
description: 'Use when scanning agent skills for security issues, prompt injection. Triggers: scan skill, audit skill security, validate SKILL.md. "audit a skill", "review skill security", "check skill for injection", "validate SKILL.md", or assess whether an agent skill is safe to install. Checks for prompt injection, malicious scripts, excessive permissions, secret exposure, and supply chain risks.'
---
