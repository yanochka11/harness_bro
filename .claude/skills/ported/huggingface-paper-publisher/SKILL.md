...
description: 'Use when publishing papers to HuggingFace Papers. Triggers: publish paper hf, hf papers submit. paper pages, linking papers to models/datasets, claiming authorship, and generating professional markdown-based research articles.'
---
