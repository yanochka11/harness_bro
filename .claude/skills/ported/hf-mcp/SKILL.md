---
name: hf-mcp
description: 'Use when connecting to HuggingFace via MCP server. Triggers: hf mcp. papers. Get repo details, fetch documentation, run compute jobs, and use Gradio Spaces as AI tools. Available when connected to the HF MCP server.'
---
