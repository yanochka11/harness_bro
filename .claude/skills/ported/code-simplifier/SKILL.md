...
description: 'Use when simplifying complex code, removing dead code, reducing complexity. Triggers: simplify code, refactor for simplicity, remove dead code. while preserving all functionality. Use when asked to "simplify code", "clean up code", "refactor for clarity", "improve readability", or review recently modified code for elegance. Focuses on project-specific best practices.'
---
