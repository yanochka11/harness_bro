---
name: create-branch
description: 'Use when creating a new git branch following naming conventions. Triggers: new branch, create branch, feature branch. to "create a branch", "new branch", "start a branch", "make a branch", "switch to a new branch", or when starting new work on the default branch.'
---
