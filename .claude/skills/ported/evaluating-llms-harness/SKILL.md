...
description: 'Use when benchmarking LLMs on standard tasks (MMLU, GSM8K, etc.) using lm-evaluation-harness. Triggers: benchmark model, eval harness, MMLU, GSM8K, lm-eval.'
version: 1.0.0
tags:
- Evaluation
