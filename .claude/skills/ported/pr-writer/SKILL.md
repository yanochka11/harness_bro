---
name: pr-writer
description: 'Use when writing GitHub pull request description following conventions. Triggers: write PR, PR description, open pull request. opening a PR or refreshing an existing PR after material changes.'
---
