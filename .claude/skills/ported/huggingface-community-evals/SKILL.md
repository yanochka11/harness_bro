...
description: 'Use when running community-shared HuggingFace evaluations. Triggers: community eval, hf eval suite. on local hardware. Use for backend selection, local GPU evals, and choosing between vLLM / Transformers / accelerate. Not for HF Jobs orchestration, model-card PRs, .eval_results publication, or community-evals automation.'
---
