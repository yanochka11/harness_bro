---
name: commit
description: 'Use when creating a git commit with a well-formed message. Triggers: commit changes, git commit, commit message. without it. Creates commits following Sentry conventions with proper conventional commit format and issue references. Trigger on any commit, git commit, save changes, or commit message task.'
---
