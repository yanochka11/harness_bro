...
description: 'Use when logging ML experiments to W&B, running sweeps, managing model registry or dashboards. Triggers: wandb, log experiment, sweep, model registry.'
version: 1.0.0
tags:
- MLOps
- Weights And Biases
