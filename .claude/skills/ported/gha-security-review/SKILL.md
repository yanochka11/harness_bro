...
description: 'Use when reviewing GitHub Actions workflows for security issues. Triggers: gha security, action security review, workflow audit. Use when asked to "review GitHub Actions", "audit workflows", "check CI security", "GHA security", "workflow security review", or review .github/workflows/ for pwn requests, expression injection, credential theft, and supply chain attacks. Exploitation-focused with concrete PoC scenarios.'
---
