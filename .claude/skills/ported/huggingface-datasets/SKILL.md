...
description: 'Use when working with HuggingFace datasets library — loading, processing, uploading. Triggers: load_dataset, hf datasets, dataset upload. subset/split metadata, paginate rows, search text, apply filters, download parquet URLs, and read size or statistics.'
---
