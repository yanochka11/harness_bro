---
name: outlines
description: "Use when LLM output должен быть строго structured (JSON по schema, regex, Pydantic). Triggers: structured output, json schema llm, pydantic llm, constrained generation. Outlines library: enforces schema на vLLM/Transformers."
version: 1.0.0
