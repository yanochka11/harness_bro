---
name: code-review
description: 'Use when reviewing code changes for quality, bugs, maintainability. Triggers: code review, review my code, review changes. reviewing pull requests, examining code changes, or providing feedback on code quality. Covers security, performance, testing, and design review.'
---
